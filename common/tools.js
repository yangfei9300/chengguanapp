...
var tools = {
	 ...
	 compareTimeStr(targetTimeStr, startTimeStr, endTimeStr) {
	    // 将字符串分割为小时、分钟和秒
	    ...
	    // 假设endTimeStr是大于或等于startTimeStr的
	    if (targetTotalSeconds >= startTotalSeconds && targetTotalSeconds <= endTotalSeconds) {
	        return '在区间内';
	    } else if (targetTotalSeconds < startTotalSeconds) {
	        return '在区间左边';
	    } else {
	        return '在区间右边';
	    }
